...
label scene1_transition:
    ...
    call show_time() from _call_show_time_4

    play music "daily_routine.mp3" fadeout 1.0 fadein 1.0
    call wakeup_intro from _call_wakeup_intro
...
label wakeup_post_choice:
    ...
    call show_time() from _call_show_time_5
    return
...
label courtyard_skip_option:
    call update_flowchart_status("courtyard_enter_option") from _call_update_flowchart_status_19
...
label courtyard_enter_option:
    call update_flowchart_status("courtyard_enter_option") from _call_update_flowchart_status_23
...
label courtyard_separate_option:
    call update_flowchart_status("courtyard_separate_option") from _call_update_flowchart_status_25
    $ increase_rel("jennie", -0.5)  
    ...
    if has_flag("jennie_friend"):
        ...
        python:
            ...
            dynamic_choices = build_reflection_choices([
                {
                    "text": "Sorry — I move at existential dread speed.",
                    "next_label": "walk_with_friends_response1",
                    "impact": {"characters": ["jennie"], "stats": {}, "flags": {}, "outcomes": {}, "emotion": {}, "immersion": {}},
                    "prompt": "What do you say?"
                },
                {
                    "text": "Was making sure the simulation was still stable.",
                    "next_label": "walk_with_friends_response2",
                    "impact": {"stats": {"reflection_score": 0.5}, "characters": [], "flags": {}, "outcomes": {}, "emotion": {}, "immersion": {}},
                    "prompt": "What do you say?"
                },
                {
                    "text": "You guys waited?",
                    "next_label": "walk_with_friends_response3",
                    "impact": {"characters": ["jennie", "mai"], "stats": {}, "flags": {}, "outcomes": {}, "emotion": {}, "immersion": {}},
                    "prompt": "What do you say?"
                }
            ])

            return_label = "journey_to_classroom_forest_outcome_outcome"
        jump handle_dynamic_choice
    else:
        ...
        python:
            ...
            reflection_choices = build_reflection_choices([
                {
                    "text": "I'm fine. Just thinking.",
                    "next_label": "walk_with_mai_response1",
                    "impact": {"stats": {"reflection_score": 1}, "characters": [], "flags": {}, "outcomes": {}, "emotion": {}, "immersion": {}},
                    "prompt": "How do you respond?"
                },
                {
                    "text": "Jennie's intense, huh.",
                    "next_label": "walk_with_mai_response2",
                    "impact": {"characters": ["mai"], "stats": {}, "flags": {}, "outcomes": {}, "emotion": {}, "immersion": {}},
                    "prompt": "How do you respond?"
                },
                {
                    "text": "Thanks for backing me up.",
                    "next_label": "walk_with_mai_response3",
                    "impact": {"characters": ["mai"], "stats": {}, "flags": {}, "outcomes": {}, "emotion": {}, "immersion": {}},
                    "prompt": "How do you respond?"
                }
            ])
...
label walk_with_friends_response1:
    jennie "Fair. We'll try to sync your dread clock tomorrow."
    jump journey_to_classroom_forest_outcome_outcome
    return

label journey_to_classroom_forest_outcome_outcome:
    hide mai
    hide jennie
    scene bg schoolgate_day with fade
...
label scene2b:
    ...
    hayashi """
        ...
        A machine learning model is the output generated when you train your machine learning algorithm with data.

        After training, when you provide a model with an input, you will be given an output.

        For example, a predictive algorithm will create a predictive model.

        Then, when you provide the predictive model with data, you will receive a prediction based on the data that trained the model.
    ...
    python:
        dynamic_choices = build_reflection_choices([
            {
                "prompt": "Imagine doing that with ten million assignments simultaneously.",
...
label ml_scale_continue:
    ...
    hayashi """
        Machine learning uses can vary greatly.

        Places where human expertise is absent — for example, orbiting satellites or rovers on Mars.

        Places where, due to a deluge of data, humans are unable to explain their expertise, such as nuances and sentiment in spoken words.

        Especially where the conditions are changing rapidly, such as the path of a storm due to ever-changing high and low pressures in the atmosphere.
        ...
        In the face of such uncertainty, many analysts either cower in fear or predict an impossibly sunny future.

        In the book Prediction Machines, three eminent economists recast the rise of AI as a drop in the cost of prediction.

        With this single, masterful stroke, they lift the curtain on the AI-is-magic hype and show how basic tools from economics provide clarity about the AI revolution.

        They also provide a basis for action by CEOs, managers, policymakers, investors, and entrepreneurs.
    ...
    hayashi "Exactly. Now consider voice sentiment analysis."
...
label ml_sentiment_continue:
    ...
    hayashi """
        There are many approaches to machine learning, noteworthy: supervised learning, unsupervised learning, and reinforcement learning.

        With supervised learning, you do not need endless data, but you have to label the data that you have — a rather expensive and arduous task.

        With unsupervised learning, you do not need to label your data.

        However, you need massive amounts of data, hence clustering algorithms do the prediction.

        With reinforcement learning, you use a feedback mechanism, where the system learns to do “thumbs up” activities and ignore the “thumbs down.”
    """
...
label forest_path_cutscene:
    ...
    python:
        dynamic_choices = build_reflection_choices([
            {
                "prompt": "Machine learning thrives in three kinds of conditions. What were they?",
...
label forest_path_question_2:
    ...
    jennie "Six playlists, labeled by mood — happy, sad, heartbreak, etc. What learning is this?"

    python:
        dynamic_choices = build_reflection_choices([
            {
                "prompt": "What learning is this?",
...
label forest_path_question_3:
    ...
    jennie "Thousand tracks, no labels. Group them by similarity. Go."

    python:
        dynamic_choices = build_reflection_choices([
            {
                "prompt": "Thousand tracks, no labels. Group them by similarity. Go.",
                "text": "Unsupervised learning.",
...
label forest_path_quiz_outro:
    ...
    if outcome("forest_path") == "success":
        call update_flowchart_status("forest_success") from _call_update_flowchart_status_26
        ...
        call update_flowchart_status("forest_partial") from _call_update_flowchart_status_27
        ...
        call update_flowchart_status("forest_fail") from _call_update_flowchart_status_28
...
label forest_path_conclude:
    ...
    if has_flag("jennie_friend"):
        ...
        $ set_outcome("forest_path_outcome", "success")
        $ set_outcome("jennie_storyline_outcome", "friend")    
        ...
        $ set_outcome("forest_path_outcome", "success")
        $ set_outcome("jennie_storyline_outcome", "worst enemy")    
        ...
        $ set_outcome("forest_path_outcome", "partial")
        $ set_outcome("jennie_storyline_outcome", "neutral")    
        ...
        $ set_outcome("forest_path_outcome", "fail")
        ...
        $ set_outcome("jennie_storyline_outcome", "enemy")    
